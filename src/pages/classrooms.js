...
if(object){
  for(let i=0;i<object.length;i++){
    courses=[...courses,{
      ...
      classroomCapacity:object[i].attributes.classroomCapacity,   
     }]
...
setLoading(false)
  ...
  /*   if(values.classroomLevel===""){
    ...
    course.set("classroomCapacity",values.classroomCapacity)       
...
setChange(!change)
  ...
  const columnsCourse = [
   ...
   // { field: 'classroomLevel', headerName: 'classroomLevel', width: 200 },
    ...
    { field: 'classroomCapacity', headerName: 'classroomCapacity', width: 200 },
  ];
          ...
          <Typography variant="h6">
              ...
              <TextField
                ...
                <TextField
                  ...
                  value={values.classroomCapacity}
                /> 
                {/*  <TextField
                fullWidth
                label="Nivel"
